  ...
  function curtirFoto(){
    ...
    return (
        <div class="post" data-test="post">
            <div class="topo">
              <div class="usuario">
                <img data-test="post-image"  src={props.imagemUsuario} />
                meowed
              </div>
              <div class="acoes">
            ...
            <div class="conteudo">
              <img src={props.imagem} onClick={curtirFoto}/>
            </div>
            ...
            <div class="fundo">
              ...
              <div class="curtidas">
                ...
                <div class="texto">
                  Curtido por <strong>respondeai</strong> e <strong >outras <span> {quantidadeLikes}</span> pessoas</strong>
                </div>
              </div>
            </div>
        </div>
